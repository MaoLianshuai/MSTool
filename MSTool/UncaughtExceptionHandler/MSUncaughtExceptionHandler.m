...
#import "MSUncaughtExceptionHandler.h"
...
@interface MSUncaughtExceptionHandler()

@property (assign, nonatomic) BOOL dismissed;

@end

@implementation MSUncaughtExceptionHandler
...
void HandleException(NSException *exception)
{
    ...
    [[[MSUncaughtExceptionHandler alloc] init]
...
void SignalHandler(int signal)
{
    ...
    NSArray *callStack = [MSUncaughtExceptionHandler backtrace];
    [userInfo setObject:callStack forKey:UncaughtExceptionHandlerAddressesKey];
